...
static int CmdHFAliroRead(const char *Cmd) {
    ...
    void *argtable[] = {
        ...
        arg_str1("p", "reader-private-key,readerprivkey,rpk", "<pem|pem-base64|der-hex|scalar-hex|path>", "Reader private key (P-256): PEM, PEM base64 body, DER hex, scalar hex, or file path"),
    ...
    if (ensure_ec_private_key(reader_private_key_text, MBEDTLS_ECP_DP_SECP256R1,
        ...
        PrintAndLogEx(INFO, "Accepted formats: PEM, PEM base64 body, DER hex, 32-byte scalar hex, or file path");
        return PM3_EINVARG;
    }
